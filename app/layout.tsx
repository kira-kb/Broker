...
// export const metadata: Metadata = {
//   title: "Broker App",
//   description: "One-person property and car broker",
// };
...
//               <Navbar />
//               <div className="flex items-center gap-2 px-4 h-12 border-t">
//                 <SidebarTrigger className="-ml-1" />
//                 <Separator
//                   orientation="vertical"
...
//             <div className="flex-1 overflow-y-scroll p-4">{children}</div>
//           </SidebarInset>
//         </SidebarProvider>
//       </body>
//     </html>
